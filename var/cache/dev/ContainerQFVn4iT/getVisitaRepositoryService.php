 ...
 */
class getVisitaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VisitaRepository' shared autowired service.
     *
     * @return \App\Repository\VisitaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VisitaRepository.php';

        return $container->privates['App\\Repository\\VisitaRepository'] = new \App\Repository\VisitaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
