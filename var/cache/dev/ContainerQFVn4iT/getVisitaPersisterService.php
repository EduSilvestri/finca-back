 ...
 */
class getVisitaPersisterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\State\VisitaPersister' shared autowired service.
     *
     * @return \App\State\VisitaPersister
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'State'.\DIRECTORY_SEPARATOR.'VisitaPersister.php';
        ...
        return $container->privates['App\\State\\VisitaPersister'] = new \App\State\VisitaPersister(($container->privates['api_platform.doctrine.orm.state.persist_processor'] ?? $container->load('getApiPlatform_Doctrine_Orm_State_PersistProcessorService')), new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        ]), ['login' => NULL, 'api' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        ]), 'dev' => NULL]), ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)));
    }
}
