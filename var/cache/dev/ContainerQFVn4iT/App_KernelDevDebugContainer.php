...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AnimalEditarFotoController' => 'getAnimalEditarFotoControllerService',
            'App\\Controller\\AnimalFotoUploadController' => 'getAnimalFotoUploadControllerService',
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UD4Zbd0W8P', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\VisitaRepository' => ['privates', 'App\\Repository\\VisitaRepository', 'getVisitaRepositoryService', true],
        ], [
            'App\\Repository\\AnimalRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Repository\\VisitaRepository' => '?',
        ])));
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AnimalEditarFotoController', 'App\\Controller\\AnimalFotoUploadController', 'App\\Controller\\AuthController', 'App\\Controller\\PerfilController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private '.service_locator.Rlg80n6' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_Rlg80n6Service($container)
    {
        return $container->privates['.service_locator.Rlg80n6'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5nTs-VinmD', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wDuP3-4Ir6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NLeWeGsMQL', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getApiPlatform_FilterLocatorService($container)
    {
        return $container->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'annotated_app_entity_animal_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_animal_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityAnimalApiPlatformDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entity_animal_api_platform_doctrine_orm_filter_search_filter' => '?',
        ]);
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a-1py7TJ1E', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        $a = ($container->privates['.service_locator.Rlg80n6'] ?? self::get_ServiceLocator_Rlg80n6Service($container));
    ...
    protected static function getSerializerService($container)
    {
        ...
        $o = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($h, $i, $j, $k, $l, $m, $b, $f, $n, [], $a);
        $p = new \ApiPlatform\Serializer\ItemNormalizer($i, $j, $k, $l, $b, $f, $n, NULL, $h, $a);
        $q = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($n);
        $r = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $f, $b, $c, $q, NULL);
        $s = new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL);

        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($b), $e, $e, new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $f), new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($g, [], $f), new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $f), $e, new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($o, $f), new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($h, $i, $j, $l, $g, $f), new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($h, $k, $g), new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($g, true, []), new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $f), new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, []), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $o, $p, new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $f), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($n, $f, $c, $q, NULL)), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($m, $l, $k, NULL), 'page', 'pagination', $h, $b, 1), $h, $l, ($container->privates['api_platform.filter_locator'] ?? self::getApiPlatform_FilterLocatorService($container))), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($r, $k, $m), $r], [new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $d, $s, new \Symfony\Component\Serializer\Encoder\CsvEncoder(), new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $s), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'lexik_jwt_authentication.token_ttl' => 360000,
